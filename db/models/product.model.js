...
const PRODUCT_TABLE = "products"; //Esté será el nombre de la base de datos.

const ProductSchema = { //Define la estructura de la DB.
...
class Product extends Model { //Se está haciendo uso de POO, al momento de hacer extends 
    ...
    static config(sequelize) { //Otro método estático que recibe una conexión usualmente
        ...
        return { //retorna la configuración
            ...
            modelName: "Product", //Tiene el mismo nombre de la clase, o sea User.
